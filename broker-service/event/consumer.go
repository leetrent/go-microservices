...
func NewConsumer(pConn *amqp.Connection) (Consumer, error) {
	logSnippet := "\n[broker-service][event][consumer][NewConsumer] =>"
...
func (consumer *Consumer) setup() error {
	logSnippet := "\n[broker-service][event][consumer][setup] =>"
...
func (consumer *Consumer) Listen(topics []string) error {
	logSnippet := "\n[broker-service][event][consumer][Listen] =>"
...
func handlePayload(payload Payload) {
	logSnippet := "\n[broker-service][event][consumer][handlePayload] =>"
...
func logEvent(entry Payload) error {
	logSnippet := "\n[broker-service][event][consumer][logEvent] =>"
